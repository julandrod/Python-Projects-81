...
def main():
    ...
    # Start 4 at 4 tries remaining, going down
...
def getWords():
    ...
    # Find two words that have 3 matching letters (but give up to 500
    ...
    for i in range(500):
        if len(words) == 12:
            break  # Found 7 or more words, so break out the loop
...
def getComputerMemoryString(words):
    ...
    for lineNum in range(16):  # The "computer memory" has 16 lines
        ...
        memoryAddress += 16 # Jumpo from, say, 0xe680 to 0xe690
