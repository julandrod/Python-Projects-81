...
NUM_FISH = 30  # (!) Try changing this to 2 or 100
NUM_BUBBLERS = 4  # (!) Try changing this number to 1 or 60
...
def generateFish():
    """Return as dictionary that represents a fish."""
...
def clearAquarium():
    ...
    for kelp in KELPS:
        for i, kelpSegment in enumerate(kelp["segments"]):
            bext.goto(kelp["x"], BOTTOM_EDGE - 2 - i)
            print(" ", end="")
